 /*
    ...
    Author itter:     https://itter.com/iEnabled
    Version:            4.0
...
(function(win, doc) {
    ...
    var Snap = Snap || function(userOpts) {
            ...
            translate: {
                ...
                x: function(n) {
                    ...
                    if( utils.canTransform() ){
                        ...
                        settings.element.style.width = (win.innerWidth || doc.documentElement.clienidth)+'px';
                        settings.elementMirror.style.width = (win.innerWidth || doc.documentElement.clienidth)+'px';
						settings.elementMirror2.style.width = (win.innerWidth || doc.documentElement.clienidth)+'px';
        ...
        this.expand = function(side){
            var to = win.innerWidth || doc.documentElement.clienidth;
            ...
            fixIE: function() {
                ...
                b.each([this.d.iframe || null, !this.o.modal ? null : this.d.overlay,
                    ...
                    if (e) {
                        var f = e[0].style;
                        f.position = "absolute";
                        if (2 > b) f.removeExpression("height"), f.removeExpression("width"), f.setExpression("height", 'document.body.scrollHeight > document.body.clientHeight ? document.body.scrollHeight : document.body.clientHeight + "px"'), f.setExpression("width", 'document.body.scrollWidth > document.body.clienidth ? document.body.scrollWidth : document.body.clienidth + "px"');
                        else {
                            var c, d;
                            a && a.constructor ===
                                Array ? (c = a[0] ? "number" === typeof a[0] ? a[0].toString() : a[0].replace(/px/, "") : e.css("top").replace(/px/, ""), c = -1 === c.indexOf("%") ? c + ' + (t = document.documentElement.scrollTop ? document.documentElement.scrollTop : document.body.scrollTop) + "px"' : parseInt(c.replace(/%/, "")) + ' * ((document.documentElement.clientHeight || document.body.clientHeight) / 100) + (t = document.documentElement.scrollTop ? document.documentElement.scrollTop : document.body.scrollTop) + "px"', a[1] && (d = "number" === typeof a[1] ?
                                    a[1].toString() : a[1].replace(/px/, ""), d = -1 === d.indexOf("%") ? d + ' + (t = document.documentElement.scrollLeft ? document.documentElement.scrollLeft : document.body.scrollLeft) + "px"' : parseInt(d.replace(/%/, "")) + ' * ((document.documentElement.clienidth || document.body.clienidth) / 100) + (t = document.documentElement.scrollLeft ? document.documentElement.scrollLeft : document.body.scrollLeft) + "px"')) : (c = '(document.documentElement.clientHeight || document.body.clientHeight) / 2 - (this.offsetHeight / 2) + (t = document.documentElement.scrollTop ? document.documentElement.scrollTop : document.body.scrollTop) + "px"',
                                    d = '(document.documentElement.clienidth || document.body.clienidth) / 2 - (this.offseidth / 2) + (t = document.documentElement.scrollLeft ? document.documentElement.scrollLeft : document.body.scrollLeft) + "px"');
