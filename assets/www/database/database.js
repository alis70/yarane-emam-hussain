// JavaScript Document//Test for browser compatibility
...
function updateCarList(transaction, results) {
    ...
    for (i = 0; i < results.rows.length; i++) {
        ...
        listholder.innerHTML += " <tr> <td align='center'><a href='" + row.model +"'>" + row.make + " </a></td>" + " <td align='center'> <a href='javascript:void(0);' onclick='deleteCar(" + row.id + ");' > <img src='images/delete-icon.png' width='30' height='35'> </a></td>";
    }
...
function addCar() {
    ...
    if (mydb) {
        ...
        var make = document.title;
        var model = document.location;
